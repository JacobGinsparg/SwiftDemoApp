...
class TireViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.title = "14X Canadian Tire 'Money'"
        ...
        // Cover
        let cover = UIImageView(image: UIImage(named: "bgCoverCtire.png"))
        ...
        // Coupon info
        let couponInfo = UIImageView(image: UIImage(named: "bgHeadlineCtire.png"))
        ...
        // Details
        let details = UIImageView(image: UIImage(named: "tireFinePrint.png"))
    ...
    func showRedeem(sender: UIButton!) {
        let barcode = UIImageView(image: UIImage(named: "bgBarcodeCtire.png"))
